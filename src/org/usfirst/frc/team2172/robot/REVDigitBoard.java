...
public class REVDigitBoard {
	...
	REVDigitBoard() {
		...
		charmap.put('B',11);
	 	charreg[12][0] = (byte)0b00001111; charreg[12][1] = (byte)0b00000000; //C \/
		charmap.put('C',12);
	 	charreg[13][0] = (byte)0b00111001; charreg[13][1] = (byte)0b00010010; //D \/
		charmap.put('D',13);
	 	charreg[14][0] = (byte)0b11001111; charreg[14][1] = (byte)0b00000000; //E \/
		charmap.put('E',14);
	 	charreg[15][0] = (byte)0b11001110; charreg[15][1] = (byte)0b00000000; //F \/
		charmap.put('F',15);
	 	charreg[16][0] = (byte)0b01101111; charreg[16][1] = (byte)0b00000000; //G \/
		charmap.put('G',16);
	...
	public void display(double angle) { // optimized for battery voltage, needs a double like 12.34
		int[] charz = {36,36,36,36};
		// idk how to decimal point
		//int ten = (int)(batt/10);
		int hundred = (int)(angle/100);
		int ten = (int)((angle/10) % 10);
		int one = (int)(angle%10);
